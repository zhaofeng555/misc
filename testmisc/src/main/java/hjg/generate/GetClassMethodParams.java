...
public class GetClassMethodParams {   
  
    public static void main(String[] args) throws Exception {   
        // 匹配静态方法   
        String[] paramNames = getMethodParamNames(GetClassMethodParams.class, "main", String[].class);   
        System.out.println(Arrays.toString(paramNames));   
        // 匹配实例方法   
        paramNames = getMethodParamNames(GetClassMethodParams.class, "foo", String.class);   
        System.out.println(Arrays.toString(paramNames));   
        // 自由匹配任一个重名方法   
        paramNames = getMethodParamNames(GetClassMethodParams.class, "getMethodParamNames");   
        System.out.println(Arrays.toString(paramNames));   
        // 匹配特定签名的方法   
        paramNames = getMethodParamNames(GetClassMethodParams.class, "getMethodParamNames", Class.class, String.class);   
        System.out.println(Arrays.toString(paramNames));   
    }   
