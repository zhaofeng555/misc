...
public class RandomNumber {
	...
	public static void main(String[] args) {
		...
		// 使用java.lang.Mat  h的random方法生成随机数
...
/*
 ...
 有的时候需要在单击文本框时全选其中的内容，这时就可以用select()方法。如下 
<input value='onClick selectAll' onClick="select()">  

 * 
 运行结果：
Math.random(): 0.06710029558420716
使用不带参数的构造方法构造的Random对象:
int: 35327123
long: -2036845946154508827
float: 0.88301855
double: 0.582588184758619
Gaussian: 0.3426314177838525
随机整数序列:349207084  -2111094685  -1137856323  938660713  -1172708633  
[0,10)范围内随机整数序列: 5  4  7  2  8  6  6  1  3  6  
[5,23)范围内随机整数序列: 10  6  8  27  16  25  5  26  25  19  
利用nextFloat()生成[0,99)范围内的随机整数序列: 22  51  27  92  90  44  69  64  75  59  
